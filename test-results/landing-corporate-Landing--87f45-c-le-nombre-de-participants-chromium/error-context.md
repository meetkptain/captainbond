...
- Name: landing-corporate.spec.ts >> Landing Corporate >> pré-remplit le formulaire avec le nombre de participants
- Location: e2e\landing-corporate.spec.ts:22:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_RESET at http://localhost:3000/corporate
Call log:
