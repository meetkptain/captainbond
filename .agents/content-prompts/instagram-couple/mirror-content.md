# Instagram Couple — Mirror Content

Contenu "c'est NOUS" — le miroir de la relation.
Trigger : reconnaissance douloureuse + "je ne suis pas seul.e".

## Format

- Plateforme : Instagram (Reel 30-60s OU Carrousel 5-10 slides)
- Duree : 30-60 secondes (Reel) / 5-10 slides (Carrousel)
...
```
Tu cree un contenu MIROIR pour @captainbond.couple (Instagram Couple).

Variables :
- {PHENOMENE} : le sentiment ou comportement que le couple reconnait
...
5-30s : Exploration du phenomene (voix off ou texte)
30-45s : Reframe — "Ce n'est pas un echec. C'est..."
45-55s : {SOLUTION} — levier concret
55-60s : {CTA}
...
### Exemple 1 : Le sentiment de coloc
```
PHENOMENE : "Vous vous aimez mais vous vous sentez comme des colocs"
...
```
PHENOMENE : "Le diner ou vous parlez des courses, du boulot, des enfants... et c'est tout"
...
```
PHENOMENE : "Vous etes en mode maintenance, pas en mode connexion"
...
- Ce contenu est le PLUS sauvegarde par l'ICP Couple
- Chaque contenu doit finir par une lueur d'espoir (pas de desespoir)
- Les references aux experts (Perel, Gottman) augmentent la credibilite
- Toujours proposer une action CONCRETE a faire ce soir
- Ne JAMAIS blamer — les deux partenaires doivent se sentir accueillis
