...
export const post: BlogPost = {
  ...
  faq: [
    ...
    takeaways: [ 'Les jeux d Halloween pour adultes désignent des activités ludiques thématisées autour de la fête d Halloween, conçues pour un public adulte avec de…', 'Des questions sur le thème de l horreur, des films cultes et des peurs irrationnelles.', 'Focus: Conseils pour une soirée Halloween réussie.' ],
  sections: [
