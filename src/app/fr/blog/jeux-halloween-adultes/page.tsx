    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <aside className="bg-gradient-to-r from-neon-purple/20 to-neon-pink/20 p-6 rounded-2xl border border-white/10 mb-12">
          <h3 className="text-xl font-semibold mb-2">Préparez votre soirée Halloween</h3>
          <p className="text-slate-200 leading-relaxed mb-4">Captain Bond a tous les jeux dont vous avez besoin : icebreaker, quiz, imposteur. La TV devient le plateau, les téléphones les manettes.</p>
