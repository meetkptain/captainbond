    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-12 article-body text-slate-300">
        ...
        <section className="article-block">
          <h2 >Pourquoi les jeux pour grands groupes sont différents</h2>
        ...
        <section className="article-block">
          <h2 >Ce qui fait un bon jeu pour grand groupe</h2>
        ...
        <section className="article-block">
          <h2 >Top 5 des jeux de soirée pour 10-50+ joueurs</h2>
          <div className="space-y-6">
            <div className="p-4 rounded-xl border border-white/10">
              <h3 >1. Icebreaker — Le brise-glace ultime</h3>
            ...
            <div className="p-4 rounded-xl border border-white/10">
              <h3 >2. Spicy — Le jeu qui chauffe l&apos;ambiance</h3>
            ...
            <div className="p-4 rounded-xl border border-white/10">
              <h3 >5. Date Night — Version grand groupe</h3>
        ...
        <section className="article-block">
          <h2 >Conseils pour animer une soirée jeux en grand groupe</h2>
          <ul className="list-disc pl-6 space-y-2 text-slate-300 mb-4">
        ...
        <aside className="bg-gradient-to-r from-neon-purple/20 to-neon-pink/20 p-6 rounded-2xl border border-white/10 mb-12">
          <h3 >Essayez Captain Bond pour votre prochaine soirée</h3>
          <p className="text-slate-200 mb-4">Captain Bond transforme votre TV en plateau de jeu et vos smartphones en manettes. Icebreaker, Spicy, Imposteur — 5 modes pour tous les groupes.</p>
